    ...
    const sections = [
        {
            ...
            content: (
                <div className="space-y-6">
                    <p className="font-gesta text-gray-900 leading-relaxed text-lg">
                        AgentAstrois a software platform developed by AgentAstroInc. that aggregates, organizes, and presents publicly available regulatory data from sources such as the U.S. Food and Drug Administration (FDA).
                    </p>
                    <p className="font-gesta text-gray-900 leading-relaxed text-lg">
                    ...
                    <div className="bg-amber-50 border border-amber-200 rounded-xl p-6">
                        <div className="flex items-start space-x-3">
                            <IoIosAlert className="w-8 h-8 text-amber-600 flex-shrink-0" />
                            <div>
                                ...
                                <ul className="space-y-3">
                                    {[
                                        ...
                                        'AgentAstrooutputs must not be filed directly with regulators without independent professional validation.',
                                        ...
                                        <li key={idx} className="flex items-center space-x-3 text-gray-900">
                                            <span className="text-lg font-gesta">{item}</span>
                                        </li>
                                    ))}
                                </ul>
                            </div>
                    ...
                    <div className="bg-red-50 border border-red-200 rounded-xl p-6">
                        <h4 className="font-gesta text-xl font-semibold text-gray-900 mb-3 flex items-center space-x-2">
                            <FaFileSignature className="w-8 h-8 text-red-500 flex-shrink-0" />
                            <span>You acknowledge and agree that:</span>
                        </h4>
                        <ul className="space-y-3">
                            {[
                                'The Services may generate incomplete or imprecise results.',
                                'AgentAstromakes no warranty as to correctness, completeness, or regulatory sufficiency of outputs.',
                                'All regulatory submissions and decisions remain your responsibility.',

                            ].map((item, idx) => (
                                <li key={idx} className="font-gesta flex items-start space-x-3 text-gray-800 text-lg">
        ...
        },
        {
            ...
            content: (
                <div className="space-y-2">
                    <p className="font-gesta text-lg text-gray-900 leading-relaxed">
                        To access the Services, you must create an account and provide accurate, complete, and up-to-date information.
                    </p>
                    <p className="font-gesta text-lg text-gray-700 leading-relaxed">
        ...
        },
        {
            ...
            content: (
                <div className="space-y-3">
                    <p className="text-lg font-gesta text-gray-900 leading-relaxed">
                    ...
                    <div className="bg-amber-50 border border-amber-200 rounded-xl p-6">
                        <div className="flex items-start space-x-3">
                            <div>
                                <p className="text-gray-900 text-lg font-gesta font-semibold">
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                        {[
                            ...
                            <div key={idx} className="bg-white rounded-xl p-2 border border-gray-200 hover:shadow-md transition-all shadow-sm">
                                <p className="text-gray-900 font-gesta text-lg">{item.desc}</p>
                            </div>
                        ))}
                    </div>
                    ...
                    <div className="bg-red-50 border border-red-200 rounded-xl p-2">
                        <div className="flex items-center space-x-3">
                            <IoIosAlert className="w-8 h-8 text-red-600" />
                            <div>
                                <p className="text-gray-900 font-gesta text-lg">We may suspend or terminate your account if you violate these Terms.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        },
        {
            ...
            content: (
                <div className="space-y-4">
                    <p className="text-lg font-gesta text-gray-900 leading-relaxed">
                        All software, code, and original content within the Services are the property of AgentAstroor its licensors. We grant you a limited, non-exclusive, non-transferable license to use the Services for your internal business purposes while your subscription is active.
                    </p>
                    <p className="text-lg font-gesta text-gray-900 leading-relaxed">
                        You retain ownership of all User Content you upload to the Services. By uploading User Content, you grant AgentAstroa limited license to process and display such content solely for the purpose of providing the Services. You represent that you have the rights and authorizations to upload any content you provide.
                    </p>

                    <div className="bg-cyan-50 border border-cyan-200 rounded-xl p-3">
                        <div className="flex items-center space-x-2">
                            <GiAmericanShield className="w-6 h-6 text-cyan-600" />
                            <div>
                                <p className="text-gray-900 font-gesta text-lg">AgentAstrodoes not claim ownership of your User Content.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="space-y-6">
                    <div className="bg-amber-50 border border-amber-200 rounded-xl p-3">
                        <div className="flex items-start space-x-4">
                            <div>
                                <p className="text-gray-900 text-lg font-gesta">
                        ...
                        <div className="grid md:grid-cols-2 gap-4">
                            {[
                                ...
                                <div key={idx} className="flex items-start space-x-2">
                                    <span className="text-gray-900 text-lg font-gesta">{item}</span>
                                </div>
                            ))}
                        </div>
                    </div>
            ...
            content: (
                <div className="space-y-6">
                    <div className="bg-red-50 border border-red-200 rounded-xl p-2">
                        <div className="flex items-start space-x-4">
                            <div>
                                <p className="text-gray-900 font-gesta text-lg">
                                    To the maximum extent permitted by law, AgentAstrois not liable for any indirect, incidental, special, consequential, or punitive damages (including lost profits, lost opportunities, or business interruption).
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-xl p-4 border border-gray-200 shadow-sm">
                        <h4 className="font-semibold font-gesta text-xl text-gray-900 mb-4">In particular, AgentAstroshall not be liable for:</h4>
                        <div className="grid gap-3">
                            {[
                                ...
                                <div key={idx} className="flex items-start space-x-2 p-2 font-gesta text-lg bg-gray-50 rounded-lg">
                                    <IoIosAlert className="w-5 h-5 text-amber-600 mt-0.5 flex-shrink-0" />
                                    <span className="text-gray-900 text-lg font-gesta">{item}</span>
                                </div>
                            ))}
                        </div>
                    ...
                    <div className="p-1">
                        <div className="flex items-center space-x-3">
                            <div>
                                <p className="text-gray-900 text-lg font-gesta">
                                    Our total liability for any claim related to the Services is limited to the greater of (a) USD $100 or (b) the fees you paid to AgentAstroin the twelve (12) months prior to the event giving rise to the claim.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div className="relative overflow-hidden">
                ...
                <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    <div className="text-center animate-fade-in">
                        ...
                        <div className="flex items-center justify-center space-x-4 text-lg text-black font-gesta font-bold">
                ...
                <div className="mt-10">
                    <div className="bg-gradient-to-r bg-[#EBEEF2] rounded-2xl p-10 border  text-center relative overflow-hidden">
                        <div className="relative">
                            ...
                            <p className="text-gray-900 font-semibold font-gesta text-lg">Email us at : &nbsp;
                                <a href="mailto:info@agentastro.ai" className="text-blue-600 font-semibold hover:text-blue-800 transition-colors">
                                    info@agentastro.ai
                                </a>
                            </p>
                        </div>
