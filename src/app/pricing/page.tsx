                                ...
                                <div className="p-6 sm:p-8 flex flex-col h-full">
                                    ...
                                    <div className="mt-auto">
                                        <button
                                            ...
                                            className="relative w-full py-4 sm:py-5 px-6 sm:px-8 rounded-xl font-semibold text-base sm:text-lg transition-all duration-500 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-offset-2 overflow-hidden bg-black hover:bg-gray-800 text-white shadow-lg focus:ring-gray-400 hover:shadow-xl disabled:opacity-70 disabled:cursor-not-allowed disabled:transform-none"
                                        >
