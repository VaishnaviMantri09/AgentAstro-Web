            ...
            content: (
                <div className="space-y-6">
                    <p className="font-gesta text-gray-900 leading-relaxed text-xl">
                        Agent Astro Inc. is a Canadian company that provides regulatory intelligence tools for medical device companies and professionals. Our software aggregates publicly available data to help users better understand regulatory pathways.
                    </p>

                    <div className="grid md:grid-cols-2 gap-4">
                        <div className="bg-gradient-to-br from-cyan-50 to-blue-50 rounded-xl p-6 border border-cyan-200 group hover:border-cyan-300 transition-all hover:shadow-md">
                            ...
                            <p className="font-gesta text-gray-900 text-lg">Ottawa, Ontario, Canada</p>
                        </div>
                        <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-xl p-6 border border-blue-200 group hover:border-blue-300 transition-all hover:shadow-md">
                            ...
                            <p className="font-gesta text-gray-900 text-lg">265 Franklin Street, Suite 1702<br />Boston, MA 02110</p>
                        </div>
                    </div>
                            ...
                            <ul className="space-y-3">
                                {[
                                    ...
                                    <li key={idx} className="flex items-center space-x-3 text-gray-900">
                                        ...
                                        <span className="text-base font-gesta">{item}</span>
                                    </li>
                                ))}
                            </ul>
                        </div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        {[
                            ...
                            <div key={idx} className={`bg-white rounded-xl p-5 border border-gray-200 hover:shadow-md transition-all shadow-sm`}>
                                <h4 className="font-semibold text-xl text-gray-900 mb-2 font-gesta">{cookie.type}</h4>
                                <p className="text-gray-900 text-lg font-gesta">{cookie.desc}</p>
                            </div>
                        ))}
                    </div>

                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                        <p className="text-blue-800 text-lg font-gesta">
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {[
                            ...
                            <div key={idx} className="flex items-center space-x-3 p-4 bg-white rounded-xl border border-gray-200 hover:shadow-md transition-all shadow-sm">
                                <span className="text-gray-900 font-medium font-gesta text-lg">{item.text}</span>
                            </div>
                        ))}
                    </div>
                    ...
                    <div className="bg-gradient-to-r from-red-50 to-orange-50 rounded-xl p-6 border border-red-200">
                        <div className="flex items-center space-x-3">
                            <AiFillStop className="w-8 h-8 text-red-600" />
                            <div>
                                <p className="font-gesta text-xl text-red-700">We do not sell or rent your personal information.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    {[
                        ...
                        <div key={idx} className="flex space-x-4 p-5 bg-white rounded-xl border border-gray-200 hover:shadow-md transition-all shadow-sm">
                            <div className="flex-1">
                                <p className="text-gray-900 text-lg font-gesta">{item.desc}</p>
                            </div>
                        </div>
                    ))}
                </div>
                ...
                <div className="space-y-6">
                    <div className="bg-gradient-to-r from-cyan-50 to-blue-50 rounded-xl p-6 border border-cyan-200">
                        ...
                        <p className="text-gray-900 text-lg font-gesta">
                            Any documents, data, or content you upload remain your property. You grant Agent Astro a limited license to process such content solely for providing the Services.
                        </p>
                    </div>
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
                        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                            <div className="flex items-center space-x-3">
                                ...
                                <div>
                                    <p className="text-gray-900 font-semibold font-gesta text-lg">To exercise your rights contact us at : &nbsp;
            ...
            content: (
                <div className="bg-amber-50 border border-amber-200 rounded-xl p-6">
                    <div className="flex items-start space-x-4">
                        ...
                        <div>
                            <p className="font-gesta text-lg text-gray-900">
            ...
            < div className=" relative overflow-hidden" >
                ...
                <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-2 py-8">
                    <div className="text-center animate-fade-in">
                        <h3 className="font-gesta text-5xl md:text-6xl font-bold text-white mb-6">
                            Privacy Policy
                        </h3>
                        <p className="font-gesta text-xl text-white/90 max-w-3xl mx-auto leading-relaxed mb-2">
                            Agent Astro Inc. (“Agent Astro,” “we,” “our,” or “us”) respects your privacy and is committed to protecting your personal information.
