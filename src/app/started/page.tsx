                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-start">
                        <div className="space-y-8">
                            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20 shadow-2xl">
                                <h2 className="font-gesta text-3xl font-bold text-gray-100 mb-6">
                                    Ways to Reach Us
                                </h2>
                                ...
                                <div className="space-y-6">
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <div>
                                            <p className="font-gesta text-lg text-[#002fa7] font-bold">Phone</p>
                                    ...
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <div>
                                            <p className="font-gesta text-lg text-[#002fa7] font-bold">
                                                Reserve your Meeting Slot
                                            </p>

                                            <button
                                                onClick={openCalModal}
                                                className="font-gesta group relative flex items-center gap-2 text-blue-600 font-semibold hover:text-blue-700 transition-all duration-300"
                                            >
                                                Schedule Call
                                    ...
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <div>
                                            <p className="font-gesta text-lg text-[#002fa7] font-bold">Email</p>
                                    ...
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <div>
                                            <p className="font-gesta text-lg text-[#002fa7] font-bold">Mailing Address</p>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div className="grid md:grid-cols-2 gap-6">
                                    <div>
                                        <label
                                            htmlFor="name"
                                            className="block text-lg font-medium text-black mb-2 font-gesta"
                                        >
                                            Full Name *
                                        </label>
                                        <input
                                            ...
                                            className={`font-gesta w-full px-4 py-3 bg-white/20 border rounded-lg text-white placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-pink-500 transition-all ${errors.name ? 'border-red-400' : 'border-white/30'
                                                }`}
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={handleInputChange}
                                            className={`font-gesta w-full px-4 py-3 bg-white/20 border rounded-lg text-white placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-pink-500 transition-all ${errors.email ? 'border-red-400' : 'border-white/30'
                                                }`}
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={handleInputChange}
                                        className={`font-gesta w-full px-4 py-3 bg-white/20 border rounded-lg text-white placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-pink-500 transition-all ${errors.subject ? 'border-red-400' : 'border-white/30'
                                            }`}
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        onChange={handleInputChange}
                                        className={`font-gesta w-full px-4 py-3 bg-white/20 border rounded-lg text-white placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-pink-500 transition-all resize-none ${errors.message ? 'border-red-400' : 'border-white/30'
                                            }`}
