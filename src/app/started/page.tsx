                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div className="grid md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className={`font-gesta w-full px-4 py-3 bg-black border rounded-lg text-white placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all ${errors.name ? 'border-red-400' : 'border-white/30'
                                                }`}
                                        />
                                        {errors.name && (
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={handleInputChange}
                                            className={`font-gesta w-full px-4 py-3 bg-black border rounded-lg text-white placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all ${errors.email ? 'border-red-400' : 'border-white/30'
                                                }`}
                                        />
                                        {errors.email && (
                                            <p className="mt-1 text-sm text-red-400 flex items-center">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={handleInputChange}
                                        className={`font-gesta w-full px-4 py-3 bg-black border rounded-lg text-white placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all ${errors.subject ? 'border-red-400' : 'border-white/30'
                                            }`}
                                    />
                                    {errors.subject && (
                                        <p className="mt-1 text-sm text-red-400 flex items-center">
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        onChange={handleInputChange}
                                        className={`font-gesta w-full px-4 py-3 bg-black border rounded-lg text-white placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all resize-none ${errors.message ? 'border-red-400' : 'border-white/30'
                                            }`}
                                    />
                                    {errors.message && (
                                        <p className="mt-1 text-sm text-red-400 flex items-center">
