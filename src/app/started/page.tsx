                            ...
                            <div className="bg-[#EBEEF2] backdrop-blur-lg rounded-2xl p-8 border border-white/20 shadow-2xl">
                                ...
                                <div className="space-y-6">
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <div>
                                            <p className="font-gesta text-lg text-black font-bold">Phone</p>
                                    ...
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <div>
                                            <p className="font-gesta text-lg text-black font-bold">
                                    ...
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <div>
                                            <p className="font-gesta text-lg text-black font-bold">Email</p>
                                    ...
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <div>
                                            <p className="font-gesta text-lg text-black font-bold">Mailing Address</p>
