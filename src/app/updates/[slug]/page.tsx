    ...
    >
      ...
      <header className="relative max-w-7xl mx-auto px-4 sm:px-6 md:px-12 py-10 md:py-16 lg:py-24 flex flex-col items-start lg:flex-row lg:items-center gap-10 lg:gap-24">
        ...
        <div className="lg:w-1/2 mt-6 md:mt-10 lg:mt-0 max-w-xl space-y-4 md:space-y-6 pl-4 md:pl-8 ">
          ...
          <p className="font-gesta text-lg md:text-xl text-indigo-900 font-semibold leading-relaxed drop-shadow">
            {article.excerpt}
          </p>
        </div>
      </header>
        ...
        <div className="mx-auto max-w-4xl text-center">
          <div className="relative">
            ...
            <div className="relative bg-gradient-to-r from-white/15 to-white/10 backdrop-blur-sm rounded-3xl p-12 border border-white/30 shadow-2xl">
              <h2 className="font-gesta text-3xl font-bold mb-6 bg-gradient-to-r from-white to-blue-100 bg-clip-text text-transparent">
                Unlock the Fast Lane to FDA Success
              </h2>
              <p className="font-gesta text-xl text-blue-100 leading-relaxed mb-6">
                Be part of a growing community streamlining FDA approvals with confidence.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href='/started'>
                  <button className="font-gesta group bg-white text-blue-600 px-8 py-4 rounded-full font-semibold hover:bg-blue-50 transition-all duration-300 flex items-center justify-center gap-2 hover:scale-105 shadow-xl">
                    Join Today
