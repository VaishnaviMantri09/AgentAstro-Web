                                ...
                                <div className="grid lg:grid-cols-2 gap-0">
                                    <div className="relative overflow-hidden">
                                        ...
                                        <div className="absolute top-4 left-4">
                                            <span className="font-gesta bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-4 py-2 rounded-full text-medium font-semibold">
                                    ...
                                    <div className="p-8 lg:p-12 flex flex-col justify-center">
                                        <h3 className="font-gesta text-3xl font-bold text-gray-800 mb-4 leading-tight group-hover:text-blue-600 transition-colors duration-300">
                                        ...
                                        <div className="flex items-center justify-between">
                                            <button className="font-gesta font-medium bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-8 py-3 rounded-full font-semibold hover:from-blue-700 hover:to-indigo-700 transform hover:scale-105 transition-all duration-300 flex items-center gap-2 group">
                                                Read Full Article
                                ...
                                <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-500">
                                    <div className="relative overflow-hidden h-48">
                                        ...
                                        <div className="absolute top-3 left-3">
                                            <span className="font-gesta bg-white/90 backdrop-blur-sm text-gray-800 px-3 py-1 rounded-full text-sm font-semibold">
                                                {article.category}
                                            </span>
                                        </div>
                                    ...
                                    <div className="p-6">
                                        ...
                                        <h3 className="font-gesta text-xl font-bold text-gray-800 mb-3 leading-snug group-hover:text-blue-600 transition-colors duration-300 line-clamp-2">
                                            {article.title}
                                        </h3>
                                        ...
                                        <div className="flex items-center justify-between">
                                            <button className="font-gesta text-blue-600 font-semibold text-medium hover:text-blue-700 transition-colors duration-300 flex items-center gap-1">
                                                Read More
                                                <ArrowRight
                ...
                <div className="text-center">
                    {visibleArticles.length < allArticlesCount && (
                        <button
                            ...
                            className="font-gesta text-lg bg-gradient-to-r from-slate-700 to-slate-800 text-white px-12 py-4 rounded-full font-semibold hover:from-slate-800 hover:to-slate-900 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl"
                        >
                            Load More Articles
                        </button>
                    )}
