                                ...
                                <div className="grid lg:grid-cols-2 gap-0">
                                    ...
                                    <div className="p-8 lg:p-12 flex flex-col justify-center">
                                        ...
                                        <div className="flex items-center justify-between">
                                            <button className="font-gesta font-medium bg-gradient-to-r from-gray-600 to-gray-700 text-white px-8 py-3 rounded-full font-semibold transform hover:scale-105 transition-all duration-300 flex items-center gap-2 group">
                                                Read Full Article
