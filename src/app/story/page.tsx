...
// Component to render formatted answer content
  ...
  return (
    <div className="space-y-2">
      {lines.map((line, index) => {
        // Check if line is a numbered item (starts with number and period)
...
const StoryPage = () => {
  ...
  const faqData = [
    ...
    ** In short: AgentAstro is both a regulatory assistant and a strategic intelligence tool, helping MedTech companies move faster from concept to clearance.** `,
    ...
    {
      question: 'How is AgentAstro different from using ChatGPT or other general AI tools?',
...
**In short: AgentAstro transforms raw FDA data into secure, submission-ready intelligence—giving MedTech teams an order-of-magnitude advantage over manual work or general AI tools.**`,
    ...
    // COMPANY INFORMATION
    {
      question: 'Who is behind AgentAstro?',
            ...
            {faqData.map((faq, index) => (
              ...
              >
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20 hover:bg-white/15 transition-all duration-500 overflow-hidden hover:scale-105 hover:shadow-xl hover-glow animate-slideInLeft card-3d">
                  ...
                  >
                    <span className="font-gesta text-lg font-bold text-gray-900 pr-4 group-hover:text-gray-700 transition-colors duration-300">{faq.question}</span>
