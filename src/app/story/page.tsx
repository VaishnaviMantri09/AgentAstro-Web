        ...
        <div className="relative mx-auto max-w-4xl text-center">
          <div className="animate-slideInDown stagger-2">
            ...
            <div className="flex justify-center animate-scaleIn stagger-4" >
              <Link href="/started">
                <button className="font-gesta text-lg group relative flex items-center gap-2 text-blue-900 font-semibold hover:text-blue-700 transition-all duration-300" >
                  Start Your Journey
            ...
            <div className="max-w-4xl mx-auto">
              ...
              >
                <div className="relative z-10">
                  <h3
                    className={`font-gesta text-3xl font-bold mb-6 ${timelineItems[activeItem].textColor} transition-all duration-500`}>
                    {timelineItems[activeItem].title}
                  </h3>
                  <p className="font-gesta text-blue-100/90 text-xl leading-relaxed">{timelineItems[activeItem].content}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-4 gap-6">
            {advisors.map((advisor, index) => (
              ...
              >
                <div className="bg-blue-900 rounded-3xl p-6 border border-white/30 transition-all duration-500 hover:scale-105 hover:-rotate-1 text-center group-hover:shadow-2xl h-full flex flex-col">
                  <div className="flex flex-col items-center justify-center flex-grow">
                    ...
                    />
                    <h4 className="font-gesta text-xl font-bold mb-3 text-white text-center">
                      {advisor.name}
                    </h4>
                    <p className="font-gesta text-medium text-blue-100 leading-relaxed text-center">
                      {advisor.bio}
                    </p>
                  </div>
                </div>
