            ...
            <header>
                <div className="py-4 px-6 relative">
                    <div className="flex items-center justify-between max-w-7xl mx-auto">
                        ...
                        <nav className="hidden md:flex items-center space-x-8 font-switzer">
                            <button
                        ...
                        <div className="hidden md:flex items-center font-switzer">
                            <Link href="/started">
                                <button className="bg-black text-white px-6 py-2 rounded-lg transition-colors">
                                    Get Started
                                </button>
                            </Link>
                        </div>
                    ...
                    {isMobileMenuOpen && (
                        <div className="md:hidden absolute top-full left-0 right-0 bg-white border-t border-gray-200 shadow-lg z-50 font-switzer">
                            ...
                            <nav className="px-6 pb-4 space-y-4">
                                ...
                                <Link href="/started">
                                    <button className="w-full bg-black text-white px-6 py-3 rounded-lg transition-colors mt-4">
                                        Get Started
                                    </button>
                                </Link>
                            </nav>
