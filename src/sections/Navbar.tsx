                    ...
                    <div className="flex items-center justify-between max-w-7xl mx-auto">
                        <div className="flex items-center">
                            <Link href="/">
                                <Image
                                    ...
                                    height={40}
                                    width={40}
                                    className="filter brightness-0 border-2 border-gray-400 shadow-md p-1 rounded-lg"
                                />
                            </Link>
                        </div>
                        ...
                        <nav className="hidden md:flex items-center space-x-8 font-gesta">
                            <button
                                ...
                                className={`relative font-bold text-black hover:text-blue-900 transition-colors pb-0.2 text-xl ${isActive('/features') ? 'text-gray-900' : ''
                                    }`}
                            >
                                Features
                                {isActive('/features') && (
                            ...
                            <button
                                ...
                                className={`relative font-bold text-black hover:text-blue-900 transition-colors pb-0.2 text-xl ${isActive('/pricing') ? 'text-gray-900' : ''
                                    }`}
                            >
                                Pricing
                                {isActive('/pricing') && (
                            ...
                            <button
                                ...
                                className={`relative font-bold text-black hover:text-blue-900 transition-colors pb-0.2 text-xl ${isActive('/updates') ? 'text-gray-900' : ''
                                    }`}
                            >
                                Updates
                                {isActive('/updates') && (
                            ...
                            <nav className="px-6 pb-4 space-y-4">
                                <button
                                    ...
                                    className={`block py-2 transition-colors w-full text-left text-xl ${isActive('/features')
                                        ? 'text-blue-600 font-medium border-l-2 border-black pl-3'
