...
const testimonials: Testimonial[] = [
  {
    text: "What Agent Astro is building is exactly what the medtech industry needs.",
    imageSrc: avatars[0],
    name: "Frank Baylis",
    username: "@frankbaylis",
  },
  {
    text: "This platform has the potential to drastically streamline the regulatory process .",
    imageSrc: avatars[1],
    name: "Josh Smith",
    username: "@jjsmith",
  },
  ...
  {
    text: "The ability to rapidly identify predicate devices and learn from past FDA decisions is a game changer for any company preparing a 510(k) submission.",
    imageSrc: avatars[3],
    name: "Casey Jordan",
    username: "@caseyj",
  },
    ...
    <div className="testimonials-wrapper">
      <div className="testimonials-section">
        <div className="section-header">
          <h1 className="main-title">What our users Say ?</h1>
        </div>
                ...
                <div className="testimonial-card" key={`row1-${idx}`}>
                  <div className="user-info">
                    ...
                    <div className="user-details">
                      ...
                      <div className="user-handle">{testimonial.username}</div>
                    </div>
                  </div>
