    ...
    <div className="testimonials-wrapper">
      <div className="testimonials-section">
        <div className="section-header">
          <h1 className="main-title font-switzer">What our users Say ?</h1>
        </div>
              ...
              {[...firstRow, ...firstRow].map((testimonial, idx) => (
                <div className="testimonial-card" key={`row1-${idx}`}>
                  <div className="user-info">
                    ...
                    />
                    <div className="user-details font-switzer">
                      <div className="user-name font-switzer">{testimonial.name}</div>
                      <div className="user-handle font-switzer">{testimonial.username}</div>
                    </div>
                  </div>
                  <div className="testimonial-text font-switzer">"{testimonial.text}"</div>
                </div>
              ))}
            </div>
          </div>
