                  ...
                  {isSubscribed ? (
                    ...
                    >
                      ...
                      <button
                        ...
                        className="font-gesta text-lg w-full bg-[#007EA6] text-gray-100 px-4 py-2.5 rounded-lg transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-xl transform hover:scale-105"
                      >
