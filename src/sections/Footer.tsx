        ...
        <div className="max-w-7xl mx-auto px-6 py-8">
            ...
            <div className="lg:col-span-4">
              <div className="mb-6 flex items-center space-x-4">
                ...
                <div className="flex flex-col">
                  ...
                  <p className="font-gesta text-blue-300 text-base font-medium">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-5 gap-4 max-w-4xl">
                <div className="lg:col-span-2 bg-gradient-to-br from-white/95 to-indigo-50/90 rounded-xl p-6 border border-white/30 hover:border-white/50 transition-all duration-300 shadow-lg backdrop-blur-sm">
                  <h3 className="font-gesta text-lg font-semibold mb-2 text-gray-800"> Don't Miss Out !</h3>
                    ...
                    >
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="font-gesta w-full bg-white/80 border border-indigo-200 rounded-lg pl-10 pr-4 py-2.5 text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:border-transparent text-base shadow-sm"
                          required
                        />
                      </div>
                      <button
                        ...
                        className="font-gesta text-lg w-full bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-gray-100 px-4 py-2.5 rounded-lg transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-xl transform hover:scale-105"
                      >
                ...
                {footerLinks.general.map((link) => (
                  <li key={link.name}>
                    <a
                      ...
                      className="text-lg text-blue-300 hover:text-white transition-colors duration-200 hover:underline"
                    >
                      {link.name}
                    </a>
                  </li>
          ...
          <div className="border-t border-blue-800 pt-6">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-4">
              <div className="font-gesta text-blue-400 text-lg">
                © {new Date().getFullYear()} AgentAstro, All rights reserved.
              </div>
              <div className="flex items-center space-x-4">
                <span className="text-blue-400 text-lg mr-2 font-gesta">Follow Us</span>
            ...
            {/* Legal links section - no extra border */}
            <div className="flex flex-wrap justify-center md:justify-start items-center gap-6 md:gap-8">
              <a
                href={getLocalizedPath("/privacy")}
                className="font-gesta text-blue-400 hover:text-white text-base transition-colors duration-200 hover:underline"
              >
                Privacy Policy
              </a>
              <a
