...
const benefits = [
    {
        ...
        description: "Identify the right predicate devices in seconds, not months.",
    },
    {
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 mb-12">
                    {benefits.map((benefit, index) => (
                        ...
                        >
                            <h3 className="font-gesta text-3xl font-bold text-gray-900 mb-3 group-hover:text-blue-600 transition-colors duration-300">
                                {benefit.title}
                            </h3>
