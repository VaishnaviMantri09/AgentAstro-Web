        ...
        <section className="relative w-full pt-4 pb-6 sm:pt-4 sm:pb-8 md:pt-8 md:pb-10 lg:pt-6 lg:pb-8">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-10">
                    <h2 className="text-4xl md:text-5xl font-bold text-white mb-4 font-switzer">
                        Core Advantages
                    </h2>
    ...
    `}
                        >
                            <div className="mb-4 flex items-center justify-center items-baseline -space-x-1">
                                <span className="text-4xl font-bold text-indigo-800 font-switzer">
                                    {benefit.title}
                                </span>
                            </div>

                            <p className="text-blue-900 text-base leading-relaxed mb-4 font-switzer">
                                {benefit.description}
                            </p>
