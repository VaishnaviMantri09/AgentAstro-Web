...
const steps: Step[] = [
  {
    title: "Ask Questions",
    description: "Use plain language for your toughest regulatory queries.",
    icon: "1",
    color: "bg-[#007EA6]",
  },
  {
    title: "Identify Predicate Devices",
    description: "Instantly access and analyze FDA data.",
    icon: "2",
    color: "bg-[#061A40]"
  },
  {
    title: "Compare Details",
    description: "Review specs, testing protocols, and pathways side by side.",
    icon: "3",
    color: "bg-[#007EA6]"
  },
  {
    title: "Market Insights",
    description: "Track regulatory updates, trends, and risks.",
    icon: "4",
    color: "bg-[#1E293B]"
  },
];
    ...
    <section className="relative overflow-hidden py-8">
      ...
      <div className="max-w-6xl mx-auto px-4 text-center relative z-40">
        <div className="mb-2">
          ...
          <p className="font-gesta text-red  font-bold text-xl md:text-2xl max-w-2xl mx-auto leading-relaxed">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4 mt-12 font-gesta">
          {steps.map((step: Step, idx: number) => (
            <div
              key={idx}
              className="group relative bg-white/95 backdrop-blur-md shadow-2xl rounded-2xl px-6 py-6 flex flex-col items-center text-center border border-white/40 hover:scale-110 hover:bg-white transition-all duration-500 hover:shadow-3xl hover:-translate-y-2 animate-fadeInUp"
              style={{
            ...
            >
              ...
              <h3 className="font-gesta text-3xl font-bold mb-3 text-gray-800 group-hover:text-gray-900 transition-colors duration-300">
                {step.title}
              </h3>
              <p className="font-gesta text-gray-600 text-xl leading-relaxed group-hover:text-gray-700 transition-colors duration-300">
                {step.description}
              </p>
            </div>
          ))}
        ...
        <div className="mt-10 text-center">
          <p className="font-bold font-gesta text-xl sm:text-xl md:text-2xl text-gray-70 mb-5">
            Ready to streamline your FDA submissions?
          </p>
          <a href="/started"
            className="inline-block px-8 py-3 text-xl font-gesta text-white rounded-lg shadow hover:shadow-lg transition-all duration-300"
            style={{
