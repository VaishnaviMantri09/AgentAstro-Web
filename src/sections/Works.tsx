  ...
  return (
    <section className="relative overflow-hidden py-8">
      ...
      <div className="max-w-6xl mx-auto px-4 text-center relative z-40">
        <div className="mb-2">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-black mb-4 drop-shadow-2xl">
            How It{' '}
            <span className="bg-gradient-to-r  bg-clip-text text-black animate-pulse">
              Works ?
            </span>
          </h2>
          <div className="w-24 h-1 bg-gradient-to-r from-yellow-400 to-pink-400 mx-auto mb-6 rounded-full shadow-lg animate-pulse" />
          <p className="text-red  font-bold text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
        ...
        <div className="mt-10 text-center">
          <p className="text-base sm:text-lg md:text-xl text-gray-70 mb-5">
            Ready to streamline your FDA submissions?
          </p>
          <a href="/started"
            className="inline-block px-8 py-3 text-base sm:text-lg font-semibold bg-indigo-600 text-white rounded-lg shadow hover:bg-indigo-700 transition-colors"
          >
            Connect with Us
          </a>
        </div>
