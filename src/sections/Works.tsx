    ...
    <section className="relative overflow-hidden py-8">
      ...
      <div className="max-w-6xl mx-auto px-4 text-center relative z-40">
        <div className="mb-2">
          ...
          <div className="w-24 h-1 bg-gradient-to-r from-[#061A40] to-[#EBEEF2] mx-auto mb-6 rounded-full shadow-lg animate-pulse" />
        ...
        <div className="mt-10 text-center">
          <p className="font-gesta text-lg sm:text-xl md:text-2xl text-gray-70 mb-5">
            Ready to streamline your FDA submissions?
          </p>
          <a href="/started"
            className="font-gesta inline-block px-8 py-3 text-lg sm:text-xl font-semibold bg-indigo-600 text-white rounded-lg shadow hover:bg-indigo-700 transition-colors"
          >
            Connect with Us
          </a>
        </div>
