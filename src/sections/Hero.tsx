    ...
    >
      ...
      <div className="relative z-30 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-center">
        <div className="max-w-2xl text-center lg:text-left">
          <h1 className="font-gesta text-3xl sm:text-5xl md:text-6xl font-bold text-gray-800 leading-tight mb-4 sm:mb-6 ">
            AI‑Powered
            <br />
            <span className="lg:whitespace-nowrap text-center font-gesta bg-gradient-to-r from-blue-900 via-yellow-700 to-pink-600 bg-clip-text text-transparent text-justify">
              Regulatory Intelligence !
            </span>
          </h1>
          <p className="font-gesta text-xl sm:text-xl text-blue-900 mb-6 sm:mb-8 max-w-lg leading-relaxed mx-auto lg:mx-0 ">
            Accelerate your FDA 510(k) submissions with faster predicate searches, deeper insights, and submission‑ready reports.
          </p>
