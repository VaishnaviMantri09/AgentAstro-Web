...
const rawArticles: Omit<Article, 'slug'>[] = [
    {
        ...
        excerpt: "Join thousands of industry leaders October 5–8, 2025, in San Diego. And make sure to stop by Booth 728 to see Agent Astro in action, grab a stuffie, and learn how we’re transforming FDA submissions with AI.",
